...
export default function AboutFFC() {
  return (
    <div className="mt-20 grid place-items-center bg-primary2">
      <div className="flex max-w-[92rem] px-8  xl:gap-48 flex-col md:flex-row">
        <div className="flex xl:max-w-[560px] lg:max-w-[499px] flex-col">
        ...
        <div className="max-w-full">
          <div className="flex flex-col border-t-[2px] border-[#2C2C2B]">
            <div className="flex  gap-10 flex-col xl:ml-20 pb-11 pt-11 sm:flex-row">
            ...
            <div className="flex w-full gap-10 flex-col    border-t-[2px]  border-[#2C2C2B] pt-11 sm:flex-row">
              <div className="flex xl:ml-20 gap-5">
