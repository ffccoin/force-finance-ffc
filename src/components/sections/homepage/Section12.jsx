...
const Section12 = () => {
  return (
    <div className="mt-16 grid place-items-center items-center justify-center rounded-lg bg-primary1 md:h-auto lg:h-[500px] lg:pl-14">
      <div className="flex max-w-7xl flex-col items-center  lg:flex-row">
        <div className="flex flex-col max-w-[41rem] p-10  text-neutral">
          <h1 className="text-wrap  text-2xl sm:text-[37.9px] uppercase leading-[42.64px] lg:mt-4">
            Unlock tomorrow's potential with FFC Coin
          </h1>
          ...
          <div className="mt-4  flex w-full flex-col gap-8 md:flex-row">
            ...
            <SecondaryButton
              ...
              size="small"
              color="neutralDarker"
              className="border-none bg-neutralLighter text-neutralDarker"
            />
          </div>
        </div>
