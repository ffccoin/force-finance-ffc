...
const Section1 = () => {
  return (
    <div className="flex w-full flex-wrap items-center justify-center bg-no-repeat pt-11 pb-20  md:mt-20 md:bg-[url('/homepage/pattern.svg')] md:bg-contain md:bg-top">
